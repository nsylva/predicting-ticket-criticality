...
### GLOBAL VARIABLES
################################################################################
filename_in = "baseline1_ticket_data_10_years_post_rtf.csv"
filename_out = "baseline1_preprocessed.csv"
...
if __name__ == '__main__':
    ...
    cols = ['PriorityID', 'PriorityID_Int', 'clean_notes',
            'label_pr_low','label_pr_norm', 'label_pr_high', 'label_pr_crit']
    ...
    dataset.to_csv(args.data[:-8]+'_preprocessed.csv')
