...
def build_model(seq_len, bert_path, dropout = 0.1):
 ...
 #   
    ...
    #dense layers
    dense1 = tf.keras.layers.Dense(512,activation = 'relu',name = 'dense_1')(dropouts)
    d1_dropouts = tf.keras.layers.Dropout(dropout)(dense1)
    dense2 = tf.keras.layers.Dense(128,activation = 'relu',name = 'dense_2')(d1_dropouts)
    d2_dropouts = tf.keras.layers.Dropout(dropout)(dense2)
    dense3 = tf.keras.layers.Dense(32,activation = 'relu',name = 'dense_3')(d2_dropouts)
    d3_dropouts = tf.keras.layers.Dropout(dropout)(dense3)
    dense4 = tf.keras.layers.Dense(8, activation = 'relu',name = 'dense_4')(d3_dropouts)
